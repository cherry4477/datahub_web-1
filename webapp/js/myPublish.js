...
$(function() {
    ...
    function addrepohtml(repocon,iscooperatestate){
        ...
        var repostr = '<div class="repo" >'+
            ...
            '<div class="left">'+
            '<div class="subtitle"><a href="repDetails.html?repname='+iscooperatestate.repname+'"><span class="curreoName">'+iscooperatestate.repname+'</span></a>'+thisiscooperatestat+'</div>'+
